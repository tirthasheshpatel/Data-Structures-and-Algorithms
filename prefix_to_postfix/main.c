...
// Converts a prefix strint to postfix.
void prefix_to_postfix(char p[])
{
    // Make a stack object and initialize the `top` as -1.
    struct stack s = {-1};
    int i=strlen(p)-1;  // used to iterate through the postfix string.
    do
    {
